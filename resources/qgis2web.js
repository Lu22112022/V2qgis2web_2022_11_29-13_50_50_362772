...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [183632.256617, 6061029.343497, 531152.994594, 6296026.996168], maxZoom: 15, minZoom: 5
    })
});


map.getView().fit([183632.256617, 6061029.343497, 531152.994594, 6296026.996168], map.getSize());
